...
badd +5 ~/.config/nvim/colors/colorschemes.lua
badd +0 ~/.config/nvim/lua/config/lazy.lua
argglobal
%argdel
edit ~/.config/nvim/colors/colorschemes.lua
...
balt ~/.config/nvim/colors/colorschemes.lua
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
